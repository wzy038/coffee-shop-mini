const allGoods = [
  { id:101, name:"蓝色深海美式", sales:53, price:16, img:"/pages/checkout/static/images/m1.png" },
  { id:102, name:"青柠冰美式", sales:124, price:18, img:"/pages/checkout/static/images/m2.png" },
  { id:103, name:"冰淇淋美式", sales:6, price:14, img:"/pages/checkout/static/images/m3.png" },
  { id:104, name:"玫瑰美式", sales:88, price:20, img:"/pages/checkout/static/images/m4.png" },
  { id:105, name:"西瓜美式", sales:88, price:28, img:"/pages/checkout/static/images/m5.png" },
  { id:106, name:"抹茶美式", sales:88, price:25, img:"/pages/checkout/static/images/m6.png" },
  { id:107, name:"话梅冰美式", sales:88, price:22, img:"/pages/checkout/static/images/m7.png" },
  { id:201, name:"红豆奶油拿铁", sales:88, price:22, img:"/pages/checkout/static/images/l1.png" },
  { id:202, name:"南瓜西米拿铁", sales:88, price:24, img:"/pages/checkout/static/images/l2.png" },
  { id:203, name:"黑芝麻糊拿铁", sales:88, price:18, img:"/pages/checkout/static/images/l3.png" },
  { id:204, name:"桂圆红枣拿铁", sales:88, price:22, img:"/pages/checkout/static/images/l4.png" },
  { id:205, name:"柑橘可可拿铁", sales:88, price:23, img:"/pages/checkout/static/images/l5.png" },
  { id:206, name:"奶盖丸子厚乳拿铁", sales:88, price:22, img:"/pages/checkout/static/images/l6.png" },
  { id:301, name:"桂花拿铁", sales:88, price:17, img:"/pages/checkout/static/images/w1.png" },
  { id:302, name:"海盐焦糖拿铁", sales:88, price:25, img:"/pages/checkout/static/images/w2.png" },
  { id:303, name:"玫瑰冰拿铁", sales:88, price:20, img:"/pages/checkout/static/images/w3.png" },
  { id:304, name:"冰淇淋香草拿铁", sales:88, price:28, img:"/pages/checkout/static/images/w4.png" },
  { id:305, name:"绿豆冰沙拿铁", sales:88, price:25, img:"/pages/checkout/static/images/w5.png" },
  { id:306, name:"咸摩卡冰拿铁", sales:88, price:22, img:"/pages/checkout/static/images/w6.png" },
  { id:401, name:"橙C美式", sales:88, price:17, img:"/pages/checkout/static/images/q1.png" },
  { id:402, name:"凤梨美式", sales:88, price:25, img:"/pages/checkout/static/images/q2.png" },
  { id:501, name:"橙芭乐椰子冷萃", sales:88, price:17, img:"/pages/checkout/static/images/a1.png" },
  { id:601, name:"西柚冷萃气泡饮", sales:53, price:16, img:"/pages/checkout/static/images/b1.png" },
  { id:602, name:"气泡冻柠茶", sales:124, price:18, img:"/pages/checkout/static/images/b2.png" },
  { id:701, name:"羽衣甘蓝华夫饼", sales:53, price:16, img:"/pages/checkout/static/images/c1.png" },
  { id:702, name:"黑芝麻酸奶杯", sales:124, price:18, img:"/pages/checkout/static/images/c2.png" },
  { id:703, name:"黑金冰酪三明治", sales:6, price:4, img:"/pages/checkout/static/images/c3.png" },
  { id:801, name:"芒果椰子海", sales:88, price:22, img:"/pages/checkout/static/images/f1.png" },
  { id:901, name:"黑色天鹅", sales:88, price:22, img:"/pages/checkout/static/images/j1.png" },
  { id:1001, name:"小米辣美式", sales:88, price:22, img:"/pages/checkout/static/images/t1.png" },
  { id:1101, name:"小黄油拿铁", sales:88, price:22, img:"/pages/checkout/static/images/h1.png" }
]
