Page({
  data: {
    ...
    goodsData: [
      ...
      [
        { id:1, name:"桂花拿铁", sales:88, price:17, img:"/pages/takeaway/static/images/w1.png" },
        { id:2, name:"海盐焦糖拿铁", sales:88, price:25, img:"/pages/takeaway/static/images/w2.png" },
        { id:3, name:"玫瑰冰拿铁", sales:88, price:20, img:"/pages/takeaway/static/images/w3.png" },
        { id:4, name:"冰淇淋香草拿铁", sales:88, price:28, img:"/pages/takeaway/static/images/w4.png" },
        { id:5, name:"绿豆冰沙拿铁", sales:88, price:25, img:"/pages/takeaway/static/images/w5.png" },
        { id:6, name:"咸摩卡冰拿铁", sales:88, price:22, img:"/pages/takeaway/static/images/w6.png" }
      ],
      [ 
        ...
        { id:5, name:"玫瑰美式", sales:88, price:25, img:"/pages/takeaway/static/images/q5.png" },
        { id:6, name:"抹茶美式", sales:88, price:22, img:"/pages/takeaway/static/images/q6.png" }
      ],
      [
        { id:1, name:"橙芭乐椰子冷萃", sales:88, price:17, img:"/pages/takeaway/static/images/a1.png" },
        { id:2, name:"冰橙子撞牛奶", sales:88, price:25, img:"/pages/takeaway/static/images/a2.png" },
        { id:3, name:"长安的荔枝", sales:88, price:20, img:"/pages/takeaway/static/images/a3.png" },
        { id:4, name:"棉花黑加仑冷萃", sales:88, price:28, img:"/pages/takeaway/static/images/a4.png" },
        { id:5, name:"日照旧金山拿铁", sales:88, price:25, img:"/pages/takeaway/static/images/a5.png" }
      ],
      [
        { id:1, name:"西柚冷萃气泡饮", sales:53, price:16, img:"/pages/takeaway/static/images/b1.png" },
        { id:2, name:"气泡冻柠茶", sales:124, price:18, img:"/pages/takeaway/static/images/b2.png" },
        { id:3, name:"苹果气泡", sales:6, price:4, img:"/pages/takeaway/static/images/b3.png" },
        { id:4, name:"百香气泡养乐多", sales:6, price:4, img:"/pages/takeaway/static/images/b4.png" }
      ],
      [
        { id:1, name:"羽衣甘蓝华夫饼", sales:53, price:16, img:"/pages/takeaway/static/images/c1.png" },
        { id:2, name:"黑芝麻酸奶杯", sales:124, price:18, img:"/pages/takeaway/static/images/c2.png" },
        { id:3, name:"黑金冰酪三明治", sales:6, price:4, img:"/pages/takeaway/static/images/c3.png" }
      ],
      [
        { id:1, name:"芒果🥭椰子海", sales:88, price:22, img:"/pages/takeaway/static/images/f1.png" },
        { id:2, name:"椰青冰美式", sales:88, price:24, img:"/pages/takeaway/static/images/f1.png" },
        { id:3, name:"生椰拿铁", sales:88, price:18, img:"/pages/takeaway/static/images/f1.png" },
        { id:4, name:"海盐薄荷冰茉莉椰子糖", sales:88, price:22, img:"/pages/takeaway/static/images/f4.png" }
      ],
      [
        { id:1, name:"黑色天鹅", sales:88, price:22, img:"/pages/takeaway/static/images/j1.png" },
      ...
      [
        { id:1, name:"小米辣美式", sales:88, price:22, img:"/pages/takeaway/static/images/t1.png" },
        { id:2, name:"无花果", sales:88, price:24, img:"/pages/takeaway/static/images/t2.png" },
      ],
      [
        { id:1, name:"小黄油拿铁", sales:88, price:22, img:"/pages/takeaway/static/images/h1.png" },
        { id:2, name:"小黄油冰美式", sales:88, price:24, img:"/pages/takeaway/static/images/h2.png" },
        { id:3, name:"小黄油厚椰拿铁", sales:88, price:18, img:"/pages/takeaway/static/images/h3.png" },
      ]
    ],
    currentGoods: [],
    cartList: [], // 购物车缓存
